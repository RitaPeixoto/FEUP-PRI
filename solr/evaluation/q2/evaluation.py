...
QUERY_URL = "http://localhost:8983/solr/goodreads/select?defType=edismax&indent=true&q.op=AND&q=interesting%20AND%20(fiction%20OR%20romance)&qf=genre%20positive_reviews&rows=30"
QUERY_URL_WEIGHT = "http://localhost:8983/solr/goodreads/select?defType=edismax&indent=true&q.op=AND&q=interesting%20AND%20(fiction%20OR%20romance)&qf=genre%5E5%20positive_reviews&rows=30"
