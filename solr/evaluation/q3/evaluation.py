...
QUERY_URL = "http://localhost:8983/solr/goodreads/select?defType=edismax&fq=totalratings%3A%5B600%20TO%20*%5D&indent=true&q.op=AND&q=easy%20and%20delicious%20vegan%20recipes&qf=genre%20desc%20positive_reviews&rows=20"
QUERY_URL_WEIGHT = "http://localhost:8983/solr/goodreads/select?defType=edismax&fq=totalratings%3A%5B600%20TO%20*%5D&indent=true&q.op=AND&q=easy%20and%20delicious%20vegan%20recipes&qf=genre%5E1.5%20desc%20positive_reviews%5E2&rows=20"
...
ax.set_title("Precision-Recall curve of Query 3")
