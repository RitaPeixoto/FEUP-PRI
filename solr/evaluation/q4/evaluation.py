...
QUERY_URL = "http://localhost:8983/solr/goodreads/select?debugQuery=false&defType=edismax&indent=true&q.op=AND&q=good%20cliche%20romance&qf=genre%20negative_reviews%20positive_reviews&rows=20"
QUERY_URL_WEIGHT = "http://localhost:8983/solr/goodreads/select?debugQuery=false&defType=edismax&indent=true&q.op=AND&q=good%20cliche%20romance&qf=genre%5E0.8%20negative_reviews%5E0.01%20positive_reviews%5E1.2&rows=20"
...
ax.set_title("Precision-Recall curve of Query 4")
