...
QUERY_URL = "http://localhost:8983/solr/goodreads-sample/select?defType=edismax&indent=true&q.op=OR&q=family&qf=genre%20title%20desc&rows=20"
QUERY_URL_WEIGHT = "http://localhost:8983/solr/goodreads-sample/select?defType=edismax&indent=true&q.op=OR&q=family&qf=genre%5E2.5%20title%20desc%5E1.5&rows=20"
